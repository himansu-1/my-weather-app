          ...
          <>
            <section className="space-y-4 ">
              ...
              <div className=" flex gap-4">
                ...
                <Container className="bg-sky-300  px-6 gap-4 justify-between overflow-x-auto">
                  <WeatherDetails
            ...
            <section className="flex w-full flex-col gap-4  ">
              <p className="text-2xl">Five Days Forcast</p>
              {firstDataForEachDate.map((d, i) => {
                ...
                <ForecastWeatherDetail
                  ...
                  date={d ? format(parseISO(d.dt_txt), "dd/MM/y") : ""}
